...
import alejandrotoigo.array.operations.exceptions.LineLengthExceededException;
import alejandrotoigo.array.operations.exceptions.TerminationException;
 ...
 */
public class LineReader extends Reader implements AutoCloseable {

    /**
     * Constructs this LineReader.
    ...
    public LineReader(InputStream in, String enc) throws UnsupportedEncodingException {
        this(in);
    }
